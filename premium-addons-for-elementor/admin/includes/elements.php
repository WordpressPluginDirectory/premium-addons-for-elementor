	...
	'cat-1'  => array(
		...
		'elements' => array(
			...
			array(
				...
				'doc'      => Helper_Functions::get_campaign_link( 'https://premiumaddons.com/docs/lottie-animations-widget-tutorial/', 'lottie', 'wp-dash', 'dashboard' ),
			...
			array(
				...
				'doc'        => Helper_Functions::get_campaign_link( 'https://premiumaddons.com/docs/divider-widget-tutorial/', 'divider', 'wp-dash', 'dashboard' ),
				'is_pro'     => true,
				'draw_svg'   => true,
			...
			array(
				...
				'doc'        => Helper_Functions::get_campaign_link( 'https://premiumaddons.com/docs/multi-scroll-widget-tutorial/', 'mscroll', 'wp-dash', 'dashboard' ),
			...
			array(
				'key'       => 'premium-lottie',
				'title'     => __( 'Lottie Animations', 'premium-addons-for-elementor' ),
				'demo'      => Helper_Functions::get_campaign_link( 'https://premiumaddons.com/elementor-lottie-animations-section-addon/', 'lottie-addon', 'wp-dash', 'dashboard' ),
			...
			array(
				...
				'doc'       => Helper_Functions::get_campaign_link( 'https://premiumaddons.com/docs/parallax-section-addon-tutorial-2/', 'parallax', 'wp-dash', 'dashboard' ),
			...
			array(
				...
				'demo'      => Helper_Functions::get_campaign_link( 'https://premiumaddons.com/animated-section-gradients-for-elementor-page-builder/', 'gradients', 'wp-dash', 'dashboard' ),
				'doc'       => Helper_Functions::get_campaign_link( 'https://premiumaddons.com/docs/animated-gradient-section-addon-tutorial/', 'gradients', 'wp-dash', 'dashboard' ),
			...
			array(
				...
				'demo'      => Helper_Functions::get_campaign_link( 'https://premiumaddons.com/ken-burns-section-addon-for-elementor-page-builder/', 'kenburns', 'wp-dash', 'dashboard' ),
				'doc'       => Helper_Functions::get_campaign_link( 'https://premiumaddons.com/docs/ken-burns-section-addon-tutorial/', 'kenburns', 'wp-dash', 'dashboard' ),
			...
			array(
				...
				'doc'       => Helper_Functions::get_campaign_link( 'https://premiumaddons.com/docs/elementor-animated-blob-generator-section-addon-tutorial/', 'blob', 'wp-dash', 'dashboard' ),
				'is_pro'    => true,
				'is_global' => true,
			),
			array(
			...
			array(
				...
				'doc'        => Helper_Functions::get_campaign_link( 'https://premiumaddons.com/docs/alert-box-widget-tutorial/', 'alert-box', 'wp-dash', 'dashboard' ),
				'is_pro'     => true,
				'draw_svg'   => true,
			...
			array(
				...
				'doc'        => Helper_Functions::get_campaign_link( 'https://premiumaddons.com/docs/elementor-off-canvas-widget/', 'off-canvas', 'wp-dash', 'dashboard' ),
				'is_pro'     => true,
				'draw_svg'   => true,
			...
			array(
				...
				'doc'   => Helper_Functions::get_campaign_link( 'https://premiumaddons.com/docs/premium-banner-widget/', 'banner', 'wp-dash', 'dashboard' ),
			),
			array(
				'key'      => 'premium-button',
				'name'     => 'premium-addon-button',
				'title'    => __( 'Button', 'premium-addons-for-elementor' ),
				'demo'     => Helper_Functions::get_campaign_link( 'https://premiumaddons.com/button-widget-for-elementor-page-builder/', 'button', 'wp-dash', 'dashboard' ),
			...
			array(
				...
				'doc'      => Helper_Functions::get_campaign_link( 'https://premiumaddons.com/docs/bullet-list-widget-tutorial/', 'bullet', 'wp-dash', 'dashboard' ),
			...
			array(
				...
				'demo'       => Helper_Functions::get_campaign_link( 'https://premiumaddons.com/charts-widget-for-elementor-page-builder/', 'charts', 'wp-dash', 'dashboard' ),
